...
namespace Results.Extensions
{
    ...
    public static class LinqExtensions
    {
        ...
        /// <summary>
        ///     Projects a result into a new form by applying a two-part selector function.
        /// </summary>
        ...
        /// <returns>
        ///     A new result representing the success or failure of applying both selector functions. If any input result
        ///     is a failure, the failure is propagated.
        /// </returns>
        /// <remarks>
        ///     This method enables LINQ query syntax with let clauses and multiple from clauses for results without
        ///     values.
        /// </remarks>
        ...
        /// <param name="self">The result to project.</param>
        /// <param name="collectionSelector">
        ///     A transform function to apply to the success case with a value, which returns a result with a collection.
        /// </param>
        ...
        /// </returns>
        /// <remarks>
        ///     This method enables LINQ query syntax with let clauses and multiple from clauses for results with values.
        /// </remarks>
